...
<template>
    <div class="bg-primary-200 border-2 border-primary rounded-lg shadow-xl p-5 pb-2 vue-action">
        ...
        <div class="action-date footer flex justify-between flex-col sm:flex-row md:flex-col 2xl:flex-row gap-1 mt-3">
            ...
            <p class="date text-secondary" v-text="getDate"></p>
        </div>
    </div>
</template>