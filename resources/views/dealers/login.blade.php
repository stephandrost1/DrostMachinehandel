    ...
    <form action="{{ route("dealer-login-action") }}" method="POST">
        ...
        <div class="flex flex-col md:flex-row md:gap-20 md:justify-center bg-white rounded-xl mt-12 px-5 py-20 md:px-10 md:py-24">
            <div class="hidden md:flex items-center">
                <img src="{{ asset('img/login-image.png') }}" alt="login image" loading="lazy">
            </div>
            ...
            <div class="flex items-center flex-col relative">
                <span class="font-bold text-[#333333] text-3xl text-center w-full mb-10 md:mb-10 flex flex-col gap-1">
                    ...
                    <span class="text-[#999999] text-base">
                         {{ __('content/login.subtext-dealer') }}
                   </span>
               </span>
                ...
                <div class="relative w-full mb-3 z-10">
                    <input class="placeholder:text-[#999999] focus:ring-primary border-none font-bold text-[#666666] block w-full bg-[#e6e6e6] h-12 rounded-2xl px-10 py-5 relative" type="password" name="{{ __('content/login.password') }}" placeholder="Password">
                    <span class="flex items-center absolute rounded-xl bottom-0 left-0 h-full pl-5">
