                    ...
                    <li class="flex-1 md:flex-none md:mr-3">
                        <div class="relative inline-block">
                            ...
                            <div id="profile-dropdown" class="dropdownlist absolute bg-gray-800 text-white right-0 w-28 mt-3 p-3 overflow-auto z-30 invisible">
                                <a href="{{ route("dashboard-settings") }}" class="flex justify-between items-center p-2 hover:bg-gray-800 text-white text-sm no-underline hover:no-underline block"><i class="fa fa-cog fa-fw"></i> Settings</a>
                                <div class="border border-white"></div>
                                <a href="{{ route("dashboard-logout") }}" class="flex justify-between items-center p-2 hover:bg-gray-800 text-white text-sm no-underline hover:no-underline block"><i class="fas fa-sign-out-alt fa-fw"></i> Log Out</a>
                            </div>
                        </div>
                    </li>
                </ul>
