...
<template>
    <div class="specs-row flex gap-2 w-full items-center">
        <div class="col-1">
            <input placeholder="Naam" type="text" class="w-full h-12 spec_name rounded-lg border-2 border-primary pl-2"
                v-model="specName">
        </div>
        <div class="col-2">
            <input placeholder="Waarde" type="text"
                class="w-full h-12 spec_name rounded-lg border-2 border-primary pl-2" v-model="specValue">
        </div>
        <div @click="_handleRemoveSpec"
            class="col-3 flex items-center justify-center bg-white shadow-md p-2 rounded-full cursor-pointer">
